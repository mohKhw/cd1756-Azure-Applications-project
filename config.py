...
class Config(object):
    ...
    BLOB_ACCOUNT = os.environ.get('BLOB_ACCOUNT') or 'cmsaccount1234'
    ...
    CLIENT_SECRET = "iAN8Q~hZ9WFCyW2qisP.QsD.GhV.0WCGmrlTKayC"  #secret value
    ...
    CLIENT_ID = "889a9a43-b617-4e9e-949f-70f444b8ce96"
